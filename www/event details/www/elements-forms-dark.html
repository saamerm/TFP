...
<html lang="en">
    ...
    <body class="appear-animate">
        ...
        <div class="page bg-dark light-content" id="top">
            ...
            <!-- Navigation panel -->
            <nav class="main-nav dark transparent sticky wow-menubar">
                <div class="full-wrapper relative clearfix">
                    ...
                    <div class="inner-nav desktop-nav">
                        <ul class="clearlist">
                            ...
                            <!-- Item With Sub -->
                            <li>
                                <a href="#" class="mn-has-sub active">Elements <i class="mn-has-sub-icon"></i></a>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <div class="wow fadeInUpShort" data-wow-delay=".1s">
                                    <h1 class="hs-line-7 mb-20 mb-xs-10">Forms</h1>
                                </div>
                ...
                <section class="page-section bg-dark light-content">
                    <div class="container relative">
                        ...
                        <div class="text-center mb-80 mb-sm-50">
                            <h2 class="section-title">Different Types</h2>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4 mb-40">
                                ...
                                <form method="post" action="#" id="form" class="form">
                                    ...
                                    <div class="mb-20 mb-md-10">
                                        <!-- Name -->
                                        <input type="text" name="name" id="name" class="input-md round form-control" placeholder="Name" maxlength="100">
                                    </div>
                                    
                                    <div class="mb-20 mb-md-10">
                                        <!-- Email -->
                                        <input type="email" name="email" id="email" class="input-md round form-control" placeholder="Email" maxlength="100">
                                    </div>    
                                    
                                    <div class="mb-20 mb-md-10">
                                        <!-- Password -->
                                        <input type="password" name="password" id="password" class="input-md round form-control" placeholder="Password" maxlength="100">
                                    </div>
                                    
                                    <div class="mb-20 mb-md-10">
                                        <textarea name="text" id="text" class="input-md round form-control" rows="6" placeholder="Text" maxlength="400"></textarea>
                                    </div>
                            ...
                            <div class="col-sm-4 mb-40">
                                ...
                                <form method="post" action="#" id="form-1" class="form">
                                    ...
                                    <div class="mb-20 mb-md-10">
                                        <select multiple class="round form-control">
                                            <option>One</option>
                                            <option>Two</option>
                                            <option>Three</option>
                                            <option>Four</option>
                                    ...
                                    <div class="mb-20 mb-md-10">
                                        <!-- Date-->
                                        <input type="date" name="date" id="date" class="input-md round form-control">
                                    </div>
                                    
                                    <div class="mb-20 mb-md-10">
                                        <!-- Color-->
                                        <input type="color" name="color" id="color" class="input-md round form-control">
                                    </div>
                                    
                                    <div class="mb-20 mb-md-10">
                                        <!-- Number -->
                                        <input type="number" name="number" id="number" class="input-md round form-control" placeholder="0" max="100">
                                    </div>   
                            ...
                            <div class="col-sm-4 mb-40">
                                ...
                                <!-- Form -->
                                <form method="post" action="#" id="form-2" class="form">
                                    
                                    <div class="mb-20 mb-md-10">
                                        <input class="input-md round form-control" id="disabledInput" type="text" placeholder="Disabled input here..." disabled>
                                    </div> 
                                    ...
                                    <div class="mb-20 mb-md-10">
                                        <label class="checkbox-inline">
                                            <input type="checkbox" id="inlineCheckbox1" value="option1"> <span class="small">Label 1</span>
                                        </label>
                                        <label class="checkbox-inline">
                                            <input type="checkbox" id="inlineCheckbox2" value="option2"> <span class="small">Label 2</span>
                                        </label>
                                        <label class="checkbox-inline">
                                            <input type="checkbox" id="inlineCheckbox3" value="option3"> <span class="small">Label 3</span>
                                        </label>
                                    </div>
                                    
                                    <div class="mb-20 mb-md-10">
                                        <label class="radio-inline">
                                            <input type="radio" name="inlineRadioOptions" id="inlineRadio1" value="option1"> <span class="small">Label 1</span>
                                        </label>
                                        <label class="radio-inline">
                                            <input type="radio" name="inlineRadioOptions" id="inlineRadio2" value="option2"> <span class="small">Label 2</span>
                                        </label>
                                        <label class="radio-inline">
                                            <input type="radio" name="inlineRadioOptions" id="inlineRadio3" value="option3"> <span class="small">Label 3</span>
                                        </label>
                                    </div>                                
                    ...
                    <div class="container relative">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4 mb-40">
                                ...
                                <!-- Form -->
                                <form method="post" action="#" id="form-3" class="form">
                                    
                                    <div class="mb-20 mb-md-10">
                                        <!-- Name -->
                                        <input type="text" name="name" id="name-1" class="form-control input-sm round" placeholder="Name" maxlength="100">
                                    </div>
                                    
                                    <div class="mb-20 mb-md-10">
                                        <!-- Email -->
                                        <input type="email" name="email" id="email-1" class="form-control input-sm round" placeholder="Email" maxlength="100">
                                    </div>    
                                    
                                    <div class="mb-20 mb-md-10">
                                        <!-- Password -->
                                        <input type="password" name="password" id="password-1" class="form-control input-sm round" placeholder="Password" maxlength="100">
                                    </div>
                                    
                                    <div class="mb-20 mb-md-10">
                                        <select class="form-control input-sm round">
                                            <option>One</option>
                                            <option>Two</option>
                                            <option>Three</option>
                                        </select>
                            ...
                            <div class="col-sm-4 mb-40">
                                ...
                                <!-- Form -->
                                <form method="post" action="#" id="form-4" class="form">
                                    
                                    <div class="mb-20 mb-md-10">
                                        <!-- Name -->
                                        <input type="text" name="name" id="name-2" class="input-md round form-control" placeholder="Name" maxlength="100">
                                    </div>
                                    
                                    <div class="mb-20 mb-md-10">
                                        <!-- Email -->
                                        <input type="email" name="email" id="email-2" class="input-md round form-control" placeholder="Email" maxlength="100">
                                    </div>    
                                    
                                    <div class="mb-20 mb-md-10">
                                        <!-- Password -->
                                        <input type="password" name="password" id="password-3" class="input-md round form-control" placeholder="Password" maxlength="100">
                                    </div>
                            ...
                            <div class="col-sm-4 mb-40">
                                ...
                                <!-- Form -->
                                <form method="post" action="#" id="form-5" class="form">
                                    
                                    <div class="mb-20 mb-md-10">
                                        <!-- Name -->
                                        <input type="text" name="name" id="name-4" class="form-control input-lg round" placeholder="Name" maxlength="100">
                                    </div>
                                    
                                    <div class="mb-20 mb-md-10">
                                        <!-- Email -->
                                        <input type="email" name="email" id="email-4" class="form-control input-lg round" placeholder="Email" maxlength="100">
                                    </div>    
                                    
                                    <div class="mb-20 mb-md-10">
                                        <!-- Password -->
                                        <input type="password" name="password" id="password-4" class="form-control input-lg round" placeholder="Password" maxlength="100">
                                    </div>
                                    
                                    <div class="mb-20 mb-md-10">
                                        <select class="form-control input-lg round">
                                            <option>One</option>
                                            <option>Two</option>
                                            <option>Three</option>
                                        </select>
